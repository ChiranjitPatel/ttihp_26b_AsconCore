#TT## SPDX-FileCopyrightText: © 2024 Tiny Tapeout
#TT## SPDX-License-Identifier: Apache-2.0
#TT#
#TT#import cocotb
#TT#from cocotb.clock import Clock
#TT#from cocotb.triggers import ClockCycles
#TT#
#TT#
#TT#@cocotb.test()
#TT#async def test_project(dut):
#TT#    dut._log.info("Start")
#TT#
#TT#    # Set the clock period to 10 us (100 KHz)
#TT#    clock = Clock(dut.clk, 10, unit="us")
#TT#    cocotb.start_soon(clock.start())
#TT#
#TT#    # Reset
#TT#    dut._log.info("Reset")
#TT#    dut.ena.value = 1
#TT#    dut.ui_in.value = 0
#TT#    dut.uio_in.value = 0
#TT#    dut.rst_n.value = 0
#TT#    await ClockCycles(dut.clk, 10)
#TT#    dut.rst_n.value = 1
#TT#
#TT#    dut._log.info("Test project behavior")
#TT#
#TT#    # Set the input values you want to test
#TT#    dut.ui_in.value = 20
#TT#    dut.uio_in.value = 30
#TT#
#TT#    # Wait for one clock cycle to see the output values
#TT#    await ClockCycles(dut.clk, 1)
#TT#
#TT#    # The following assersion is just an example of how to check the output values.
#TT#    # Change it to match the actual expected output of your module:
#TT#    assert dut.uo_out.value == 50
#TT#
#TT#    # Keep testing the module by changing the input values, waiting for
#TT#    # one or more clock cycles, and asserting the expected output values.
